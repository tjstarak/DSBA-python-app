...
def value_apartment(apartment, val_model):
...
if __name__ == "__main__":
    ...
    num_vars = ["Surface_clean", "Monthly charges_clean","Floor_clean","Construction year_clean","Number of rooms_clean"]
    predicted = ["Price_clean"]
